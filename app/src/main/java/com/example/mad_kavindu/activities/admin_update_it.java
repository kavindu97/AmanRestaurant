...
public class admin_update_it extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_update_it);
    ...
    public void onClick(View v) {
        ...
        if ("".equals(newName) || "".equals(newPrice) || "".equals(newDetails) || "".equals(newPhotoUrl)) {
            ...
            updated = myDatabaseHelper.updateRecord(rowIDtoEdit, newName, newPrice, newDetails, newPhotoUrl);
            updated = myDatabaseHelper.updatecustomerRecord(rowIDtoEdit, newName, newPrice, newDetails, newPhotoUrl);

        if (updated) {
            Toast.makeText(this, "Updated successfully", Toast.LENGTH_SHORT).show();
            setResult(RESULT_OK);
        } else Toast.makeText(this, "Updating failed run", Toast.LENGTH_SHORT).show();
    }
}
